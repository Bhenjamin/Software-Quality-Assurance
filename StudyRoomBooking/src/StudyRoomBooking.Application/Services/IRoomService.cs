...
public interface IRoomService
{
    ...
    Task<List<Room>> SearchRoomsAsync(DateTime date, TimeSpan? startTime, TimeSpan? endTime, int? capacity = null, RoomType? type = null, string? location = null, StudentMajor? studentMajor = null);
